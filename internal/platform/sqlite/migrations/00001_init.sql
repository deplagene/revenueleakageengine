...
DROP TABLE IF EXISTS leakage_evidence;
DROP TABLE IF EXISTS leakage_cases;
DROP TABLE IF EXISTS reconciliation_runs;
DROP TABLE IF EXISTS actual_revenue_entries;
DROP TABLE IF EXISTS expected_revenue_entries;
